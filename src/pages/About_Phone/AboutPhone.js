...
export default function AboutPhone() {
  return (
    <Container >
      ...
      <div   className=" border   mt-5  rounded-xl border-transparent bg-gray-100 w-44 h-1/2  " > <div className='h-min w-5/12 m-4 mt-10'><img src={phoneImage} alt='Phone' /></div><div className='m-4'> <div className='text-lg'>MIUI version</div> <div  className='text-gray-500 text-xs italic '><div> MIUI Global</div><div>12.5.2 </div><div>Stable</div></div></div></div>
        <div className='ml-2'>
          <div className="border border-transparent  rounded-xl w-40 h-1/3 mt-5 mb-2.5  bg-gray-100 ">
            <div className='m-4 text-lg'>Device name
          ...
          <div className=" border-transparent border-2 rounded-xl w-40 h-32   bg-gray-100" >
      ...
      <Link to={"/specs"} className='Link'>
        <div className='m-4 mr-4 flex rounded'>
          All specs
        </div>
      ...
      <Link to={"/BackUp&Restore"} className='Link'>
        <div className='  flex rounded my-4 pt-4'>
          Back up and restore
        </div>
        <i className="fa-solid fa-angle-right "></i>
      </Link>
      <Link to={"/Reset"} className='Link'>
        <div className='  flex rounded my-3 pb-4'>
          Factory reset
        </div>
        <i className="fa-solid fa-angle-right "></i>
      </Link>
